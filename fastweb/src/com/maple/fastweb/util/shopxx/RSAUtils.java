...
public final class RSAUtils {
	...
	public static void main(String[] args) {
		...
		String src = "sssssssss-0_#$@ddfd099ry啊啊啊";
		System.out.println("源数据="+ src);

		String en = base64encode(encrypt(publicKey,src.getBytes()));
		System.out.println("加密数据="+ en);

		String de = new String(decrypt(privateKey,base64decode(en)));
		System.out.println("解密数据="+ de);
